...
public class CompatBlackHoleStorage implements ISolarFluxCompat
{
	...
	public void registerRecipes(IForgeRegistry<IRecipe> ifr)
	{
		...
		ifr.register(new ShapedOreRecipe(new ResourceLocation(InfoSF.MOD_ID), new ItemStack(darkMatter.getBlock(), 2), "ccc", "sds", "sds", 'c', dmPhotovoltaicCell, 's', new ItemStack(SolarsSF.SOLAR_8.getBlock()), 'd', "matterDark").setRegistryName(InfoSF.MOD_ID, "solar_panel_dark_matter"));
	}
}