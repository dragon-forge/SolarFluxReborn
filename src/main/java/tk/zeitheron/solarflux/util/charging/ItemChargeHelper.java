...
import tk.zeitheron.solarflux.util.charging.fe.FEChargeHandler;
...
public class ItemChargeHelper
{
	 ...
	 */
	public static <T extends AbstractCharge> T chargePlayer(PlayerEntity player, T charge, boolean simulate)
	{
		IChargeHandler<T> h = getHandler(charge);
		if(h == null)
			return charge;
